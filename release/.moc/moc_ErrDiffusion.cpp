...
void ErrDiffusion::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ErrDiffusion *_t = static_cast<ErrDiffusion *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ErrDiffusion::staticMetaObject = {
    { &ImageFilter::staticMetaObject, qt_meta_stringdata_ErrDiffusion.data,
      qt_meta_data_ErrDiffusion,  qt_static_metacall, nullptr, nullptr}
};
