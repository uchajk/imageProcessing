...
# Project:  CS470.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile CS470.pro
#############################################################################
...
Makefile: CS470.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
